...
function Dashboard() {
    ...
    const [ipAddress, setIpAddress] = useState('192.168.98.252');
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
                                        ...
                                        <div
                                            ...
                                            className="block p-6 bg-gray-700 rounded-lg hover:bg-gray-600 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl cursor-pointer"
                                        >
            ...
            {showIpModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-gray-800 rounded-lg p-6 w-96 shadow-xl">
                        <h3 className="text-xl font-semibold mb-4 text-white">Enter IP Address</h3>
                        <p className="text-gray-300 mb-4">Please enter the Raspberry Pi IP address to connect to the Invoice System</p>
                        
                        <div className="mb-4">
                            <label htmlFor="modalIpAddress" className="block text-gray-300 text-sm mb-2">IP Address:</label>
                            <input
                                type="text"
                                id="modalIpAddress"
                                value={ipAddress}
